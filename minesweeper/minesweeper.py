...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # create new sentence with the data
        new_sentence = Sentence(neighbors,count)
        # add sentence to knowledge base
        self.knowledge.append(new_sentence)
        # find intersecting sentences and create a new sentence from them
        for sentence1 in self.knowledge:
            for sentence2 in self.knowledge:
                cells1 = deepcopy(sentence1.cells)
                cells2 = deepcopy(sentence2.cells)
                if cells1.intersection(cells2) != set() and sentence1.count - sentence2.count >= 0:
    ...
    def make_safe_move(self):
        ...
        if len(self.safes) == len(self.moves_made):
            return None
        cells = deepcopy(self.safes) - deepcopy(self.moves_made)
        return list(cells)[0] 
